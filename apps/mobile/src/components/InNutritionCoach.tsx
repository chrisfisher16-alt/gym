...
import { sendNutritionQuickMessage } from '../lib/coach-api';

interface InNutritionCoachProps {
  visible: boolean;
  onClose: () => void;
}

export function InNutritionCoach({ visible, onClose }: InNutritionCoachProps) {
  ...
  const handleSend = useCallback(
    async (message: string) => {
      ...
      setCustomInput('');
      try {
        const result = await sendNutritionQuickMessage(message);
